<template>
  <div id="body" class="vh-100 d-flex align-items-center">
    <loader object="#ff9633" color1="#ffffff" color2="#17fd3d" size="5" speed="2" bg="#343a40" objectbg="#999793" opacity="80" name="circular" v-if="isPreload"></loader>
    <div class="container">
      <div class="row content">
        <div class="col-md-6 mb-3">
          <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
            id="b809eb86-ec6b-4213-aa3e-83f4128e49a5" data-name="Layer 1" class="img-fluid" viewBox="0 0 1082 725">
            <defs>
            ...
            <g opacity="0.2">
              ...
              <ellipse cx="446.94" cy="712.41" rx="22.64" ry="30.29" transform="translate(-203.56 27.07) rotate(-12.59)"
                fill="#3f3d56" />
              <ellipse cx="438.37" cy="676.4" rx="22.64" ry="30.29" transform="translate(-195.91 24.33) rotate(-12.59)"
                fill="#3f3d56" />
              <ellipse cx="429.79" cy="640.4" rx="22.64" ry="30.29" transform="translate(-188.27 21.6) rotate(-12.59)"
                fill="#3f3d56" />
              <ellipse cx="421.21" cy="604.4" rx="22.64" ry="30.29" transform="translate(-180.63 18.86) rotate(-12.59)"
                fill="#3f3d56" />
              <path
            ...
            <g opacity="0.2">
              ...
              <ellipse cx="735.48" cy="704.75" rx="34.66" ry="26.48"
                transform="translate(-125.72 1245.01) rotate(-81.82)" fill="#3f3d56" />
              <ellipse cx="741.51" cy="662.82" rx="34.66" ry="26.48"
                transform="translate(-79.05 1215.01) rotate(-81.82)" fill="#3f3d56" />
              <ellipse cx="747.53" cy="620.89" rx="34.66" ry="26.48"
                transform="translate(-32.38 1185.01) rotate(-81.82)" fill="#3f3d56" />
              <ellipse cx="753.56" cy="578.97" rx="34.66" ry="26.48" transform="translate(14.29 1155.01) rotate(-81.82)"
                fill="#3f3d56" />
              <path
            ...
            <path
              ...
              transform="translate(-59 -87.5)" fill="url(#b7709055-0dd4-48d6-ac10-5a758f15d1a1)" />
            <path
            ...
            <path
              ...
              transform="translate(-59 -87.5)" fill="url(#f59ba046-7ebe-407e-be3d-c62856fc1078)" />
            <path
            ...
            <circle cx="593" cy="116" r="7" fill="#00bfa6" opacity="0.1" />
          </svg>
        </div>
        <div class="col-md-6">
          <h3 class="signin-text mb-3"> Sign In</h3>
          <b-alert variant="danger" show v-if="form.validate">{{ form.validate }}</b-alert>
  ...
  methods: {
    ...
    async handleLogin() { 
      try {
        ...
        this.form.validate = error.response.data.message
